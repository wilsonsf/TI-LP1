...
NoChar::NoChar(std::string *valor, NoChar* anterior, NoChar* proximo)
  : valor(valor), anterior(anterior), proximo(proximo) { }

NoChar::NoChar(std::string valor, NoChar* anterior, NoChar* proximo)
  : anterior(anterior), proximo(proximo) { 
  this->valor = new std::string;
  *this->valor = valor;
...
// Getters e Setters
std::string * NoChar::getValor() const { return this->valor; }
void NoChar::setValor(std::string *valor) { 
  if (this->valor){
    delete this->valor; 
  }
  this->valor = valor;
